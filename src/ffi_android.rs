...
#[no_mangle]
pub unsafe extern "system" fn Java_com_match_android_JniApi_initLogger(_: JNIEnv, _: JClass) {
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_match_android_JniApi_greet(
    env: JNIEnv,
    _: JClass,
    who: JString,
) -> jstring {
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_match_android_JniApi_add(
    _env: JNIEnv,
    _: JClass,
    value1: jint,
    value2: jint,
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_match_android_JniApi_passObject(
    env: JNIEnv,
    _: JClass,
    object: JObject,
) {
    ...
    let my_str_j_value = env
        .get_field(object, "stringPar", "Ljava/lang/String;")
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_match_android_JniApi_returnObject(
    env: JNIEnv,
    _: JClass,
) -> jobject {
    let cls = env.find_class("com/match/android/Dummy");

    let my_int_j_value = JValue::from(123);

    let str_parameter_j_string = env
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_match_android_JniApi_registerCallback(
    env: JNIEnv,
    _: JClass,
    callback: jobject,
) {
